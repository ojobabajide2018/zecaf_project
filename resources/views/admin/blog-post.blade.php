                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle"><code>Add Latest News To Zazzau's Emirate Blog</code></h6>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="{{route('upload-blog-post')}}" method="POST" class="m-b-30 m-t-40" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    <label for="exampleInputPassword1" class="form-label">Post Paragraph</label>
                                                    <input type="text" class="form-control" name="paragraph" id="exampleInputPassword1" placeholder="Paragraph">
                                                </div>
                                                <div class="form-group">
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h4 class="d-inline">Blog Post <a href="#code1" data-bs-toggle="collapse"><i class="fa fa-code" data-bs-toggle="tooltip" title="Get code"></i></a></h4>
                                    <p class="text-muted m-t-0">Latest News From Zazzau's Emirate Blog</p>
                                    ...
                                    <div class="row">
                                        ...
                                        @forelse($posts as $post)
                                            <div class="col-lg-3 col-md-6">
                                                <!-- Card -->
                                                <div class="card">
                                                    <img class="card-img-top img-responsive" src="images/{{$post->blog_image}}"alt="Card image cap">
                                                    <div class="card-body">
                                                        <h4 class="card-title">{{$post->blog_title}}</h4>
                                                        <p class="card-text">{{ Str::limit($post->blog_paragraph, 85) }}</p>
