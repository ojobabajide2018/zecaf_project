                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle"><code>Change homepage image below:</code></h6>
                            ...
                            <form action="{{route('upload-image-slider')}}" method="POST" class="m-b-30 m-t-40" enctype="multipart/form-data">
                                @csrf
                                <div class="row justify-content-center">
                                    <div class="col-sm-8 ">
                                        <div class="input-group">
                                            <input class="form-select js--animations" type="file" name="image">

                                            </input>
                                            <span class="input-group-btn">
                                                <button class="btn btn-info js--triggerAnimation text-white" type="submit">Upload</button>
                                            </span>
                                        </div>
                                    </div>
                                </div>
