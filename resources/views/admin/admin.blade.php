                        ...
                        <div class="carousel slide" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="active carousel-item">
                                    <div class="overlaybg" style="background:url(assets/images/news/slide6.jpg) no-repeat center center /cover"></div>
                                    <div class="blogs-content carousel-caption"><span class="label label-danger label-rounded">Homepage</span>
                                        <h4>You can change the homepage image.</h4> <a href="javascript:void(0)">Click Here</a>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="overlaybg" style="background:url(assets/images/news/slide6.jpg) no-repeat center center /cover"></div>
                                    <div class="blogs-content carousel-caption"><span class="label label-primary label-rounded">Homepage</span>
                                        <h4>You can change the homepage image.</h4> <a href="javascript:void(0)">Click Here</a>
                                    </div>
                                </div>
                                <div class="carousel-item">
                                    <div class="overlaybg" style="background:url(assets/images/news/slide6.jpg) no-repeat center center /cover"></div>
                                    <div class="blogs-content carousel-caption"><span class="label label-success label-rounded">Homepage</span>
                                        <h4>You can change the homepage image.</h4> <a href="javascript:void(0)">Click Here</a>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="card-body ">
                                    <div class="row weather">
                                        <div class="col-6 m-t-40">
                                            <h3>&nbsp;</h3>
                                            <div class="display-4">{{$temperature_in_celcius}}<sup>°C</sup></div>
                            ...
                            <div class="message-box" id="msg" style="height: 430px;position: relative;">
                                <div class="message-widget message-scroll">
                                    ...
                                    <a href="javascript:void(0)">
                                        <div class="user-img"> <img src="assets/images/users/1.jpg" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                                        <div class="mail-contnet">
                                            <h5>Pavan kumar</h5> <span class="mail-desc">Welcome to ZECAF Admin CMS</span> <span class="time">9:30 AM</span> </div>
                                    </a>
                                    <!-- Message -->
                                    <a href="javascript:void(0)">
                                        <div class="user-img"> <img src="assets/images/users/2.jpg" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
