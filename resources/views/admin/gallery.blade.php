                ...
                <div class="col-12">
                    <div class="card">
                        <div class="card-body">
                            ...
                            <h6 class="card-subtitle"><code>Add / remove Pictures / Videos Here:</code></h6>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <div class="card">
                                        <div class="card-body">
                                            <form action="{{route('upload-gallery')}}" method="POST" class="m-b-30 m-t-40" enctype="multipart/form-data">
                                                @csrf
                                                ...
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" name="caption" id="exampleInputPassword1" placeholder="Image caption">
                                                </div>
                            ...
                            <div class="row">
                                <div class="col-12">
                                    <h4 class="d-inline">Gallery <a href="#code1" data-bs-toggle="collapse"><i class="fa fa-code" data-bs-toggle="tooltip" title="Get code"></i></a></h4>
                                    <p class="text-muted m-t-0">Gallery of The Zazzau Emirate</p>
                                    ...
                                    <div class="row">
                                        ...
                                        @forelse($images as $image)
                                            <div class="col-lg-3 col-md-6">
                                                <!-- Card -->
                                                <div class="card">
                                                    <img class="card-img-top img-responsive" src="images/{{$image->image}}"alt="Card image cap">
                                                    <div class="card-body">
                                                        <h4 class="card-title">{{$image->caption}}</h4>
